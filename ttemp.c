 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --no-compress --font FontAwesome5-Solid+Brands+Regular.woff --range 62810,63650 --format lvgl -o quic.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 47, .adv_w = 322, .box_w = 20, .box_h = 13, .ofs_x = 0, .ofs_y = 1}
};
...
{
    {
        .range_start = 62810, .range_length = 841, .glyph_id_start = 1,
